...
const steps = [
  {
    ...
    step: '01',
    color: '#10b981',
    title: 'Χαρτογραφούμε την κλινική σας',
    description: 'Ξεκινάμε από τις υπηρεσίες, το ωράριο και τη δική σας εμπειρία ασθενούς.',
    bullets: ['Υπηρεσίες', 'Ομάδα', 'Ωράριο'],
  },
  {
    icon: Settings,
    step: '02',
    color: '#6366f1',
    title: 'Συνδέουμε ό,τι ήδη λειτουργεί',
    description: 'Η ομάδα μας διαμορφώνει το ClinicFlow γύρω από τα εργαλεία και τις ροές σας.',
    bullets: ['Τηλέφωνο', 'Ημερολόγιο', 'Ροές ομάδας'],
  },
  {
    icon: Zap,
    step: '03',
    color: '#f59e0b',
    title: 'Ενεργοποιούμε τη Sophia',
    description: 'Η Sophia μαθαίνει τον τρόπο που εξυπηρετείτε και υποστηρίζει την ομάδα σας σε κάθε αίτημα.',
    bullets: ['Φυσική συνομιλία', 'Βάση γνώσης', 'Έξυπνα follow-ups'],
  },
  {
    icon: BarChart3,
    step: '04',
    color: '#ec4899',
    title: 'Βλέπετε και βελτιώνετε',
    description: 'Έχετε καθαρή εικόνα της εξυπηρέτησης και των ευκαιριών που δημιουργούνται κάθε ημέρα.',
    bullets: ['Καθαρό dashboard', 'Ειδοποιήσεις', 'Αναφορές'],
  },
]
